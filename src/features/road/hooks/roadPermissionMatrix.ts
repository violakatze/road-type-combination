import { admin, permission, road, RoadPermissionListItemType } from '../types'

// 道路種別の指定可否マトリックス
export const roadPermissionMatrix: RoadPermissionListItemType[] = [
  // 国土交通大臣
  {
    admin: admin.Minister,
    permissions: [
      { road: road.Expressway, permission: permission.Ok }, // 高速自動車国道
      { road: road.NationalHighway, permission: permission.Ok }, // 一般国道
      { road: road.CityHighway, permission: permission.Alert }, // 都市高速道路
      { road: road.MajorLocalRoad, permission: permission.Alert }, // 主要地方道
      { road: road.PrefecturalRoad, permission: permission.Alert }, // 一般都道府県道
      { road: road.DesignatedCityRoad, permission: permission.Alert }, // 指定市道
      { road: road.City, permission: permission.Alert } // 市町村道
    ]
  },
  // 都道府県または知事
  {
